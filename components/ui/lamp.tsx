  ...
  return (
    <div
      className={cn(
        ...
        "backdrop-blur-2xl bg-gray-100 dark:bg-gray-950",
    ...
    >
      <div className="relative flex w-full h-full scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-yellow-400 via-transparent to-transparent dark:from-white dark:via-transparent dark:to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-yellow-400 dark:from-transparent dark:via-transparent dark:to-white text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-yellow-500 dark:bg-white opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-yellow-400 dark:bg-gray-100 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-yellow-400 dark:bg-gray-100"
        ></motion.div>
